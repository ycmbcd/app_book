<template>
    <div>
        ...
        <div @click="bookLists=1" class="btn">目录</div>
        <div id="book_lists_box">
            <div id="book_lists" v-show="bookLists">
                <div @click="bookLists=0" id="close_lists" class="fa fa-window-close fa-3x"></div>
                <div class="book_list">
                    <ul>
                        <li>
                        ...
                        <li class="list_2">
                            <a href="#/BookContent">2.1xxx</a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <a href="#/BookPic"><div class="btn">图库</div></a>
    </div>
</template>
